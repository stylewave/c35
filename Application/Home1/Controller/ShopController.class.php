...
class ShopController extends HomeController
{
	...
	public function install()
	{
		...
		if (in_array('shop', $game_arr)) {
			...
			if (!isset($tableMap['qq3479015851_shop'])) {
			...
			if (!isset($tableMap['qq3479015851_shop_log'])) {
			...
			if (!isset($tableMap['qq3479015851_shop_type'])) {
			...
			if (!isset($tableMap['qq3479015851_shop_coin'])) {
