...
function send_moble_yunpian($moble, $content)
{

	$apikey = "9754bad8884400d252a6783077024c4a"; //修改为您的apikey(https://www.yunpian.com)登录官网后获取
	$mobile = $moble; //请用自己的手机号代替
	$text="【币咖网】您的验证码是".$content;
	$ch = curl_init();
	...
	// 发送短信
	$data=array('dc'=>'15','sm'=>$text,'pw'=>$apikey,'da'=>$mobile,'tf'=>'3','rf'=>'1',"un"=>'1585170013');
...
function send_moble_yunpian2($moble, $content)
{

	$apikey = "58657ab56aa9b680c90b"; //修改为您的apikey(https://www.yunpian.com)登录官网后获取
	$mobile = $moble; //请用自己的手机号代替
	$text="您的验证码是".$content;
	$ch = curl_init();
...
function send($ch,$data){
    curl_setopt ($ch, CURLOPT_URL, 'http://api.qirui.com:7891/mt');
